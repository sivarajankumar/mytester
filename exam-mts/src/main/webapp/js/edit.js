...
var arr = window.showModalDialog('/resource/question/edit/selcolor.htm','u','dialogwidth=450px;dialogheight=560px;status=no');
...
var arr = showModalDialog("/resource/question/edit/table.htm", "", "dialogWidth:18.5em; dialogHeight:11.5em; status:0");
...
"2.文档中，系统会自动帮您上传图片文件到服务器目录\r\n\r\n"+
"3.可以用直接选中所要编辑的符号用工具栏对应的按钮编辑.\r\n\r\n"+
"4.按住shift+enter键将直接换行.\r\n\r\n";
alert(helpmess);
...
{
    var ret= window.showModalDialog('/resource/question/edit/uploadimg.jsp','u','dialogwidth=450px;dialogheight=250px;status=no');
    if(null==ret)return;
    var img = Composition.document.selection.createRange();
...
{
    var ret= window.showModalDialog('/resource/question/edit/uploadflash.jsp','u','dialogwidth=470px;dialogheight=250px;status=no');
...
function uploadmult()
{
    var ret= window.showModalDialog('/resource/question/edit/uploadmult.jsp','u','dialogwidth=470px;dialogheight=250px;status=no');
    if(null==ret)return;
    var img = Composition.document.selection.createRange();
    img.pasteHTML(ret);
    Composition.focus();
...
{
    var ret= window.showModalDialog('/resource/question/edit/uploadattcah.jsp','u','dialogwidth=470px;dialogheight=150px;status=no');
    if(null==ret)return;
    var img = Composition.document.selection.createRange();
    img.pasteHTML(ret);
    Composition.focus();
