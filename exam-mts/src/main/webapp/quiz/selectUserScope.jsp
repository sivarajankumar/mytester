 ...
 <table bgcolor=#fffff border=0 align="center" width=100% height="100%"> 
    ...
    <tr bgcolor="#F0F9FF">
      <td width=35% align="center" rowspan=2>
       <iframe src="" height=100% width=98% frameborder="0" name="leftFrame" marginwidth="0" marginheight="0"></iframe>
	  </td>
	  <td width=65% align="left" height="40%">
       <iframe src="<%=request.getContextPath()%>/Quiz.do?method=selectUserScope&course=<%=request.getParameter("course") %>" height=100% width=100% frameborder="0" name="rightFrame" scrolling=no marginwidth="0" marginheight="0"></iframe>
	  </td>
     </tr>
     <tr bgcolor="#F0F9FF">
