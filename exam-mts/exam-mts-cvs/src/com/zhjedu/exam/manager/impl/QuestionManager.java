...
public class QuestionManager extends BaseManager implements
	...
	public boolean isHave(ZjQuestion question){
		String hql = "from ZjQuestion where questioncontext like'" + question.getQuestioncontext() + "'";
		if(question.getId() != null && !"".equals(question.getId())){
			hql += " and id <>'" + question.getId() + "'";
		}
		if(question.getCategory() != null && !"".equals(question.getCategory())){
			hql += " and category='" + question.getCategory() + "'";
		}
		if(question.getParent() != null && !"".equals(question.getParent())){
			hql += " and parent='" + question.getParent() + "'";
		}
