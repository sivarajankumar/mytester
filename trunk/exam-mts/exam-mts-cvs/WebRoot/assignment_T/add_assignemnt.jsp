...
<html:form action="Question.do?method=addassignemnt" method="post">
<table border="0" width="100%" id="table4">
  ...
  <tr>
    <td><div align="left">
      <table border="0" width="100%" id="table4">
        <tr bgcolor="#7FBEE6">
          <td height="30" colspan="4"><p align="center" class="style1"><strong> 增加考试</strong></p></td>
        </tr>
        <tr bgcolor="#EEF7FF">
          <td width="27%"><p align="left" class="style1"> 考试编号</p></td>
          <td align="center"><p align="left">
            <input type="text" name="T10" size="20"  style="float: left" />
          </p></td>
          <td align="center"><p align="left" class="style1">考试名称</p></td>
          <td width="18%" align="center"><p align="left">
            <input type="text" name="T11" size="20" style="float: left" />
          </p></td>
        </tr>
        <tr bgcolor="#F7FBFF">
